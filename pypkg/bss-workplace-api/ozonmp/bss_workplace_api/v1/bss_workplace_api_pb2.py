...
_LISTWORKPLACEV1REQUEST = _descriptor.Descriptor(
  name='ListWorkplaceV1Request',
  full_name='ozonmp.bss_workplace_api.v1.ListWorkplaceV1Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LISTWORKPLACEV1RESPONSE = _descriptor.Descriptor(
  name='ListWorkplaceV1Response',
  full_name='ozonmp.bss_workplace_api.v1.ListWorkplaceV1Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='items', full_name='ozonmp.bss_workplace_api.v1.ListWorkplaceV1Response.items', index=0,
...
_LISTWORKPLACEV1RESPONSE.fields_by_name['items'].message_type = _WORKPLACE
...
DESCRIPTOR.message_types_by_name['ListWorkplaceV1Request'] = _LISTWORKPLACEV1REQUEST
DESCRIPTOR.message_types_by_name['ListWorkplaceV1Response'] = _LISTWORKPLACEV1RESPONSE
...
ListWorkplaceV1Request = _reflection.GeneratedProtocolMessageType('ListWorkplaceV1Request', (_message.Message,), dict(
  DESCRIPTOR = _LISTWORKPLACEV1REQUEST,
  __module__ = 'ozonmp.bss_workplace_api.v1.bss_workplace_api_pb2'
  # @@protoc_insertion_point(class_scope:ozonmp.bss_workplace_api.v1.ListWorkplaceV1Request)
  ))
_sym_db.RegisterMessage(ListWorkplaceV1Request)

ListWorkplaceV1Response = _reflection.GeneratedProtocolMessageType('ListWorkplaceV1Response', (_message.Message,), dict(
  DESCRIPTOR = _LISTWORKPLACEV1RESPONSE,
  __module__ = 'ozonmp.bss_workplace_api.v1.bss_workplace_api_pb2'
  # @@protoc_insertion_point(class_scope:ozonmp.bss_workplace_api.v1.ListWorkplaceV1Response)
  ))
_sym_db.RegisterMessage(ListWorkplaceV1Response)
...
_BSSWORKPLACEAPISERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\020\"\016/v1/workplaces'),
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ListWorkplaceV1',
    full_name='ozonmp.bss_workplace_api.v1.BssWorkplaceApiService.ListWorkplaceV1',
    index=2,
    containing_service=None,
    input_type=_LISTWORKPLACEV1REQUEST,
    output_type=_LISTWORKPLACEV1RESPONSE,
