...
// Source: github.com/ozonmp/bss-demo-api/internal/app/repo (interfaces: EventRepo)
...
func (m *MockEventRepo) Add(arg0 []model.WorkplaceEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.WorkplaceEvent, error) {
	m.ctrl.T.Helper()
